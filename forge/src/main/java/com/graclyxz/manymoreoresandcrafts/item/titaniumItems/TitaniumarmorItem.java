...
import static com.graclyxz.manymoreoresandcrafts.init.ManyMoreOresAndCraftsModItems.TITANIUMINGOT;

public class TitaniumarmorItem extends ArmorItem {

    public static final Holder<ArmorMaterial> ARMOR_MATERIAL = register("titanium", Util.make(new EnumMap<>(ArmorItem.Type.class),
                    attribute -> {
