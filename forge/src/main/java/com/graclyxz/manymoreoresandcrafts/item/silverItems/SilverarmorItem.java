...
import static com.graclyxz.manymoreoresandcrafts.init.ManyMoreOresAndCraftsModItems.SILVERINGOT;

public class SilverarmorItem extends ArmorItem {

    public static final Holder<ArmorMaterial> ARMOR_MATERIAL = register("silver", Util.make(new EnumMap<>(ArmorItem.Type.class),
                    attribute -> {
