...
public abstract class TungstenarmorItem extends ArmorItem {
	...
	public static class Helmet extends TungstenarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/tungstenarmor_layer_1.png";
		}
	}
	...
	public static class Leggings extends TungstenarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/tungstenarmor_layer_2.png";
		}
	}
