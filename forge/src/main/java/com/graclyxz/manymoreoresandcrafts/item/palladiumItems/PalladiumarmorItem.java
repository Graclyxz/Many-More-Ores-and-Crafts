...
import static com.graclyxz.manymoreoresandcrafts.init.ManyMoreOresAndCraftsModItems.PALLADIUMINGOT;

public class PalladiumarmorItem extends ArmorItem {

    public static final Holder<ArmorMaterial> ARMOR_MATERIAL = register("palladium", Util.make(new EnumMap<>(ArmorItem.Type.class),
                    attribute -> {
