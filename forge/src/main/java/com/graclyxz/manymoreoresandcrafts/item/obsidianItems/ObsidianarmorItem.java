...
import static com.graclyxz.manymoreoresandcrafts.init.ManyMoreOresAndCraftsModItems.OBSIDIANINGOT;

public class ObsidianarmorItem extends ArmorItem {

    public static final Holder<ArmorMaterial> ARMOR_MATERIAL = register("obsidian", Util.make(new EnumMap<>(ArmorItem.Type.class),
                    attribute -> {
