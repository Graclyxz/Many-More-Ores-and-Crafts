...
public abstract class SilverarmorItem extends ArmorItem {
	...
	public static class Helmet extends SilverarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/silverarmor_layer_1.png";
		}
	}
	...
	public static class Leggings extends SilverarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/silverarmor_layer_2.png";
		}
	}
