...
public abstract class MythrilarmorItem extends ArmorItem {
	...
	public static class Helmet extends MythrilarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/mythrilarmor_layer_1.png";
		}
	}
	...
	public static class Leggings extends MythrilarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/mythrilarmor_layer_2.png";
		}
	}
