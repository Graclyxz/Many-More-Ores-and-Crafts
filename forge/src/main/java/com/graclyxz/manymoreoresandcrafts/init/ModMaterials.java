...
public class ModMaterials {
    ...
    public static final RegistryObject<ArmorMaterial> ADAMANTITE = register("adamantite", createMap(new int[]{3, 8, 6, 3, 8}),
            22, SoundEvents.ARMOR_EQUIP_IRON, 1f, 0.1f, () -> Ingredient.of(ModTags.Items.ADAMANTITE_INGOT));

    public static final RegistryObject<ArmorMaterial> COBALT = register("cobalt", createMap(new int[]{2, 7, 5, 2, 7}),
            15, SoundEvents.ARMOR_EQUIP_IRON, 0.5f, 0f, () -> Ingredient.of(ModTags.Items.COBALT_INGOT));

    public static final RegistryObject<ArmorMaterial> INFERNAL = register("infernal", createMap(new int[]{3, 8, 6, 3, 8}),
            15, SoundEvents.ARMOR_EQUIP_NETHERITE, 1f, 0.2f, () -> Ingredient.of(ModTags.Items.INFERNAL_INGOT));

    public static final RegistryObject<ArmorMaterial> LEAD = register("lead", createMap(new int[]{2, 4, 3, 1, 4}),
            14, SoundEvents.ARMOR_EQUIP_IRON, 0f, 0f, () -> Ingredient.of(ModTags.Items.LEAD_INGOT));

    public static final RegistryObject<ArmorMaterial> MYTHRIL = register("mythril", createMap(new int[]{2, 7, 5, 2, 7}),
            24, SoundEvents.ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.of(ModTags.Items.MYTHRIL_INGOT));

    public static final RegistryObject<ArmorMaterial> OBSIDIAN = register("obsidian", createMap(new int[]{2, 6, 5, 2, 6}),
            22, SoundEvents.ARMOR_EQUIP_NETHERITE, 2f, 0.4f, () -> Ingredient.of(ModTags.Items.OBSIDIAN_INGOT));

    public static final RegistryObject<ArmorMaterial> ORICHALCUM = register("orichalcum", createMap(new int[]{2, 6, 5, 2, 6}),
            22, SoundEvents.ARMOR_EQUIP_DIAMOND, 1f, 0.2f, () -> Ingredient.of(ModTags.Items.ORICHALCUM_INGOT));

    public static final RegistryObject<ArmorMaterial> PALLADIUM = register("palladium", createMap(new int[]{2, 7, 5, 2, 7}),
            25, SoundEvents.ARMOR_EQUIP_IRON, 0.5f, 0f, () -> Ingredient.of(ModTags.Items.PALLADIUM_INGOT));

    public static final RegistryObject<ArmorMaterial> PLATINUM = register("platinum", createMap(new int[]{2, 6, 5, 2, 6}),
            15, SoundEvents.ARMOR_EQUIP_GOLD, 0.2f, 0f,() -> Ingredient.of(ModTags.Items.PLATINUM_INGOT));

    public static final RegistryObject<ArmorMaterial> SILVER = register("silver", createMap(new int[]{2, 5, 4, 2, 5}),
            16, SoundEvents.ARMOR_EQUIP_CHAIN, 0f, 0f, () -> Ingredient.of(ModTags.Items.SILVER_INGOT));

    public static final RegistryObject<ArmorMaterial> TIN = register("tin", createMap(new int[]{2, 3, 2, 1, 3}),
            6, SoundEvents.ARMOR_EQUIP_IRON, 0f, 0f, () -> Ingredient.of(ModTags.Items.TIN_INGOT));

    public static final RegistryObject<ArmorMaterial> TITANIUM = register("titanium", createMap(new int[]{2, 6, 5, 2, 8}),
            14, SoundEvents.ARMOR_EQUIP_TURTLE, 3f, 0.2f, () -> Ingredient.of(ModTags.Items.TITANIUM_INGOT));

    public static final RegistryObject<ArmorMaterial> TUNGSTEM = register("tungsten", createMap(new int[]{2, 5, 4, 2, 5}),
            16, SoundEvents.ARMOR_EQUIP_IRON, 0f, 0f, () -> Ingredient.of(ModTags.Items.TUNGSTEM_INGOT));

    public static final RegistryObject<ArmorMaterial> COPPER = register("copper", createMap(new int[]{2, 3, 2, 1, 3}),
            6, Holder.direct(SoundEvents.COPPER_HIT), 0f, 0f, () -> Ingredient.of(ModTags.Items.COPPER));

    public static final RegistryObject<ArmorMaterial> AMETHYST = register("amethyst", createMap(new int[]{2, 4, 3, 2, 4}),
            25, Holder.direct(SoundEvents.AMETHYST_BLOCK_RESONATE), 0f, 0f, () -> Ingredient.of(ModTags.Items.AMETHYST_SHARD));

    public static final RegistryObject<ArmorMaterial> EMERALD = register("emerald", createMap(new int[]{3, 6, 5, 3, 4}),
    ...
    private static RegistryObject<ArmorMaterial> register(String name, EnumMap<Type, Integer> defense, int i, Holder<SoundEvent> holder, float f, float g, Supplier<Ingredient> supplier) {
        return MATERIALS.register(name, () -> new ArmorMaterial(defense, i, holder, supplier, List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(MOD_ID, name))), f, g));
    }
