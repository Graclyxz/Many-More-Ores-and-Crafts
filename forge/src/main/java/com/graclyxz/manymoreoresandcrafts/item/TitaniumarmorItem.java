...
public abstract class TitaniumarmorItem extends ArmorItem {
	...
	public static class Helmet extends TitaniumarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/titaniumarmor_layer_1.png";
		}
	}
	...
	public static class Leggings extends TitaniumarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/titaniumarmor_layer_2.png";
		}
	}
