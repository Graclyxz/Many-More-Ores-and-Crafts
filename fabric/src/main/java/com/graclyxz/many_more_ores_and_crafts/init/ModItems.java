...
public class ModItems {
    ...
    public static final List<Item> ADAMANTITE_ITEMS = registerAllItems("adamantite", Tool.ADAMANTITE, Armor.ADAMANTITE,
            new float[]{7f, -3f}, new float[]{6f, -2.8f}, new float[]{8f, -3f}, new float[]{0f, -2f}, new float[]{5f, -3f},
            new Item.Properties().rarity(Rarity.RARE));
    public static final List<Block> ADAMANTITE_BLOCKS = registerAllBlocks("adamantite",  new float[]{8f, 10f}, SoundType.DEEPSLATE,
            BlockBehaviour.Properties.of(),
            new Item.Properties().rarity(Rarity.RARE));

    public static final List<Item> COBALT_ITEMS = registerAllItems("cobalt", Tool.COBALT, Armor.COBALT,
            new float[]{4f, -1.6f}, new float[]{3f, -2.8f}, new float[]{5f, -2.8f}, new float[]{0f, -2f}, new float[]{2f, -3f},
            new Item.Properties().rarity(Rarity.RARE));
    ...
    public static final List<Item> INFERNAL_ITEMS = registerAllItems("infernal", Tool.INFERNAL, Armor.INFERNAL,
            new float[]{6f, -2.2f}, new float[]{5f, -2.8f}, new float[]{7f, -2.8f}, new float[]{0f, -2f}, new float[]{4f, -3f},
            new Item.Properties().fireResistant().rarity(Rarity.RARE));
    public static final List<Block> INFERNAL_BLOCKS = registerAllBlocks("infernal",  new float[]{8f, 10f}, SoundType.NETHER_ORE,
            BlockBehaviour.Properties.of(),
            new Item.Properties().fireResistant().rarity(Rarity.RARE));

    public static final List<Item> LEAD_ITEMS = registerAllItems("lead", Tool.LEAD, Armor.LEAD,
            new float[]{4f, -2.6f}, new float[]{3f, -2.8f}, new float[]{5f, -3.1f}, new float[]{0f, -1f}, new float[]{3f, -3f},
            new Item.Properties());
    ...
    public static final List<Item> MYTHRIL_ITEMS = registerAllItems("mythril", Tool.MYTHRIL, Armor.MYTHRIL,
            new float[]{5f, -2.6f}, new float[]{4f, -2.8f}, new float[]{6f, -3f}, new float[]{1f, -2f}, new float[]{3f, -3f},
    ...
    public static final List<Item> OBSIDIAN_ITEMS = registerAllItems("obsidian", Tool.OBSIDIAN, Armor.OBSIDIAN,
            new float[]{7f, -3.4f}, new float[]{6f, -3f}, new float[]{8f, -3.6f}, new float[]{1f, -2f}, new float[]{5f, -3.2f},
    ...
    public static final Block OBSIDIAN_BLOCK = registerBlock("obsidian_block", Block::new, BlockBehaviour.Properties.of()
            ...
            new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON));
    public static final Block RAW_OBSIDIAN_BLOCK = registerBlock("raw_obsidian_block", Block::new, BlockBehaviour.Properties.of()
                    .requiresCorrectToolForDrops().strength(4f, 6f).sound(SoundType.METAL),
            new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON));

    public static final List<Item> ORICHALCUM_ITEMS = registerAllItems("orichalcum", Tool.ORICHALCUM, Armor.ORICHALCUM,
            new float[]{5f, -2.4f}, new float[]{4f, -2.8f}, new float[]{6f, -3f}, new float[]{0f, -2f}, new float[]{3f, -3f},
            new Item.Properties().rarity(Rarity.RARE));
    public static final List<Block> ORICHALCUM_BLOCKS = registerAllBlocks("orichalcum",  new float[]{8f, 10f}, SoundType.DEEPSLATE,
            BlockBehaviour.Properties.of(),
            new Item.Properties().rarity(Rarity.RARE));
    ...
    public static final List<Item> PLATINUM_ITEMS = registerAllItems("platinum", Tool.PLATINUM, Armor.PLATINUM,
            new float[]{3f, -2.4f}, new float[]{1f, -2.8f}, new float[]{4f, -3f}, new float[]{0f, -3f}, new float[]{1f, -3f},
    ...
    public static final List<Item> SILVER_ITEMS = registerAllItems("silver", Tool.SILVER, Armor.SILVER,
            new float[]{4f, -1.8f}, new float[]{3f, -2.8f}, new float[]{5f, -3.1f}, new float[]{0f, -1f}, new float[]{3f, -3f},
            new Item.Properties().rarity(Rarity.UNCOMMON));
    ...
    public static final List<Item> TIN_ITEMS = registerAllItems("tin", Tool.TIN, Armor.TIN,
            new float[]{3f, -2.4f}, new float[]{2f, -2.8f}, new float[]{5f, -3.2f}, new float[]{0f, -2f}, new float[]{2f, -3f},
            new Item.Properties());
    ...
    public static final List<Item> TITANIUM_ITEMS = registerAllItems("titanium", Tool.TITANIUM, Armor.TITANIUM,
            new float[]{6f, -2.6f}, new float[]{5f, -2.8f}, new float[]{7f, -3f}, new float[]{1f, -2f}, new float[]{4f, -3f},
            new Item.Properties().rarity(Rarity.EPIC));
    ...
    public static final List<Item> TUNGSTEM_ITEMS = registerAllItems("tungsten", Tool.TUNGSTEM, Armor.TUNGSTEM,
            new float[]{4f, -2.4f}, new float[]{3f, -2.8f}, new float[]{5f, -3.1f}, new float[]{0f, -1f}, new float[]{3f, -3f},
            new Item.Properties().rarity(Rarity.UNCOMMON));
    ...
    */
    ...
    public static final List<Item> AMETHYST_ITEMS = registerItems("amethyst", Tool.AMETHYST, Armor.AMETHYST,
            new float[]{4f, -2.4f}, new float[]{3f, -2.8f}, new float[]{5f, -3.2f}, new float[]{0f, -2f}, new float[]{2f, -3f},
            new Item.Properties().rarity(Rarity.UNCOMMON));

    public static final List<Item> EMERALD_ITEMS =  registerItems("emerald", Tool.EMERALD, Armor.EMERALD,
            new float[]{5f, -2.4f}, new float[]{4f, -2.8f}, new float[]{6f, -3.2f}, new float[]{0f, -2f}, new float[]{3f, -3f},
            new Item.Properties());
