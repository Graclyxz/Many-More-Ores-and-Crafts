...
public abstract class InfernalarmorItem extends ArmorItem {
	...
	public static class Helmet extends InfernalarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/infernalarmor_layer_1.png";
		}
	}
	...
	public static class Leggings extends InfernalarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/infernalarmor_layer_2.png";
		}
	}
