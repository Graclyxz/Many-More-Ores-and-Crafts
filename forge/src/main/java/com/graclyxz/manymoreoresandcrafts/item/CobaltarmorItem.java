...
public abstract class CobaltarmorItem extends ArmorItem {
	...
	public static class Helmet extends CobaltarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/cobaltarmor_layer_1.png";
		}
	}
	...
	public static class Leggings extends CobaltarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "many_more_ores_and_crafts:textures/models/armor/cobaltarmor_layer_2.png";
		}
	}
