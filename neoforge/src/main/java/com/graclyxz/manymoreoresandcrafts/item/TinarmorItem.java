...
public abstract class TinarmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_iron")), () -> Ingredient.of(new ItemStack(ManyMoreOresAndCraftsModItems.TININGOT.get())),
					List.of(new ArmorMaterial.Layer( ResourceLocation.parse("many_more_ores_and_crafts:tin"))), 0f, 0f);
			registerHelper.register( ResourceLocation.parse("many_more_ores_and_crafts:tinarmor"), armorMaterial);
